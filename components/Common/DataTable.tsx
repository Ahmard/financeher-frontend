...
const DataTable = <T extends IBaseData>(props: IProps<T>) => {
    ...
    const makeDefaultParams = () => ({
        ...
        length: cachedTableState?.query?.length || pageSize,
    });
    ...
    const [pagination, setPagination] = useState<DatatablePagination>({
        ...
        pageSize: cachedTableState?.query?.length || pageSize,
    });
                        ...
                        <Table>
                            ...
                            <TableBody>
                                {isFetching ? (
                                    ...
                                    <TableRow>
                                        <TableCell colSpan={(tableColumns.length + (withSelection ? 1 : 0))}
                                                ...
                                                {tableColumns.map((column) => (
                                                    ...
                                                    >
                                                        {(() => {
                                                            ...
                                                            if (isRenderedCell(rendered)) return (rendered as {
                                                                children: ReactNode
                                                            }).children;
