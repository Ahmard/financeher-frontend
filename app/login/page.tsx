...
import {getCallbackUrl} from "@/lib/helpers/navigation";
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    try {
      ...
      if (login_response?.ok) {
        ...
        // LOGIN FAILURE
        const resp: XhrResponse<LooseObject> = JSON.parse(
          ...
          <div className="w-full max-w-md">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex justify-between">
                    ...
                    <Link href="/forgot-password" className="!text-[#006A4B] hover:underline font-bold ms-1">
                      Forgot Password?
                    </Link>
                  </div>
                  <Input
              ...
              <p className="text-center text-sm text-gray-600 mt-6">
                ...
                <Link href="/register" className="!text-[#006A4B] hover:underline font-bold ms-1">Sign Up</Link>
              </p>
            </div>
          </div>
        </form>
