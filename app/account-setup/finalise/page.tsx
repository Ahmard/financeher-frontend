...
export default function AccountSetupFinalisePage() {
  ...
  const [selectedGrowthStages, setSelectedGrowthStages] = useState<string[]>([]);
  ...
  const handleGrowthStageToggle = (stageId: string) => {
    setSelectedGrowthStages(prev =>
      prev.includes(stageId)
        ? prev.filter(item => item !== stageId)
        : [...prev, stageId]
    );
  };
  ...
  const handleContinue = () => {
    ...
    console.log({
      ...
      growthStageIds: selectedGrowthStages,
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Answer a few questions about your business and we'll match you with the most suitable funding opportunities.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm text-gray-600">What is the current growth stage of your business?</p>
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                {growthStages.map((stage) => (
                  <button
                    ...
                    className={`px-3 py-2 text-sm rounded-full border transition-colors ${
                      selectedGrowthStages.includes(stage.id)
                        ? 'bg-green-700 text-white border-green-700'
                        : 'bg-white text-gray-700 border-gray-300 hover:border-gray-400'
                    }`}
                  >
            ...
            <div className="flex gap-3 pt-4">
              <button
                ...
                className="flex-1 bg-green-700 hover:bg-green-800 text-white font-medium py-3 px-6 rounded-lg transition-colors"
              >
                Continue
              </button>
              <button
